# 📊 Backtest Report — `all33_loose`

Generated: 2026-05-17 08:20:12
...
- ❌ **Win Rate ≥ 45%**: threshold = ≥ 45%, actual = 40.48%
- ❌ **Profit Factor ≥ 1.3**: threshold = ≥ 1.3, actual = 0.94
- ❌ **Max Drawdown ≤ 25%**: threshold = ≤ 25%, actual = 71.22%
- ❌ **Expectancy > 0**: threshold = > 0, actual = -0.21%

## 📤 Exit Reason Breakdown

| exit_reason | n_trades | win_rate | avg_return |
| --- | --- | --- | --- |
| hold_days_expired | 39 | 56.41% | 1.65% |
| stop_loss_triggered | 33 | 0.00 | -7.68% |
...
| cat_4_components | 15 | 26.67% | -0.81% | -37.87% |
| cat_3_packaging | 15 | 73.33% | 1.77% | -14.77% |
| cat_6_cloud_software | 6 | 16.67% | -6.24% | -26.67% |
