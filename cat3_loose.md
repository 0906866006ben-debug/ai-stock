# 📊 Backtest Report — `cat3_loose`

Generated: 2026-05-17 08:17:13
...
- ✅ **Win Rate ≥ 45%**: threshold = ≥ 45%, actual = 73.33%
- ✅ **Profit Factor ≥ 1.3**: threshold = ≥ 1.3, actual = 1.87
- ✅ **Max Drawdown ≤ 25%**: threshold = ≤ 25%, actual = 14.77%
- ✅ **Expectancy > 0**: threshold = > 0, actual = 1.77%

## 📤 Exit Reason Breakdown

| exit_reason | n_trades | win_rate | avg_return |
| --- | --- | --- | --- |
| hold_days_expired | 11 | 1.00 | 5.21% |
| stop_loss_triggered | 4 | 0.00 | -7.68% |

## 🤖 Sector Breakdown (6-Layer AI Framework)

| sector_category | n_trades | win_rate | avg_return | max_drawdown |
| --- | --- | --- | --- | --- |
| cat_3_packaging | 15 | 73.33% | 1.77% | -14.77% |
...
| stock_id | signal_date | entry_date | exit_date | hold_days | net_return_pct | exit_reason |
| --- | --- | --- | --- | --- | --- | --- |
| 6147 | 2025-02-10 | 2025-02-11 | 2025-03-12 | 20 | 1.53% | hold_days_expired |
...
| 6147 | 2025-03-24 | 2025-03-25 | 2025-04-07 | 7 | -7.68% | stop_loss_triggered |
