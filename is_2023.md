# 📊 Backtest Report — `is_2023`

Generated: 2026-05-17 01:58:49
...
- ✅ **Win Rate ≥ 45%**: threshold = ≥ 45%, actual = 62.50%
- ✅ **Profit Factor ≥ 1.3**: threshold = ≥ 1.3, actual = 1.52
- ✅ **Max Drawdown ≤ 25%**: threshold = ≤ 25%, actual = 14.77%
- ✅ **Expectancy > 0**: threshold = > 0, actual = 1.49%

## 📤 Exit Reason Breakdown

| exit_reason | n_trades | win_rate | avg_return |
| --- | --- | --- | --- |
| hold_days_expired | 5 | 1.00 | 6.99% |
...
| --- | --- | --- | --- | --- |
| cat_3_packaging | 8 | 62.50% | 1.49% | -14.77% |
...
- Total signals: 8
- Unique stocks: 3
- Date range: 2023-08-18 → 2023-12-20
